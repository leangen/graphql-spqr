 ...
 */
public class DataFetchingException extends GraphQLException implements GraphQLError {
    ...
    public DataFetchingException(ExecutionPath path, Throwable exception, SourceLocation sourceLocation) {
